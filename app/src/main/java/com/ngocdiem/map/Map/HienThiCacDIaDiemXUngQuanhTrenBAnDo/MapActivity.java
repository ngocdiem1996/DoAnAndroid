...
import com.ngocdiem.map.Map.HienThiDanhSachTheoCumDiaDiemDaChon.PlaceFinder;
...
import static com.ngocdiem.map.R.id.myMap1;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, DirectionFinderListener,PlaceFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(myMap1);
